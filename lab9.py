...
if __name__ == "__main__":
    ...
    divided = Button(gui, text="/", fg='black', bg='red', command=lambda: press("/"), height=1, width=7)
    divided.grid(row=5, column=3)

    clearButton = Button(gui, text='Clear', fg='black', bg='red', command=clear, height=1, width=7)
